    ...
    <div class="col-md-8">
      <div class="card mt-4">
        ...
        <div class="card-body">
          ...
          @endif
          <form method="POST" action="{{ route('admin.assistants.update', $assistant->id) }}">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="middle_name" name="middle_name" value="{{ old('middle_name', $assistant->middle_name) }}">
            </div>
            <div class="mb-3">
